...
public class JobLauncherDetails extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext contextFromQuartz) {
		Map<String, Object> jobDataMap = contextFromQuartz.getMergedJobDataMap();
		Date now = new Date();
		jobDataMap.put("TIME_STAMP", now.toString());
		// Add date stamp in map
		// Based on current time, which one timezone 2 am is it?
		// if its PST 2 am , add date + PST
