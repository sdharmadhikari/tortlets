...
Ext.define('MyApp.controller.DreamsTabController', {
    ...
    config: {
        ...
        control: {
            ...
            "button[name='dreamListPanelDreamAdd']": {
                tap: 'onDreamListPanelDreamAddButtonTap'
            }
        }
    },
    ...
    onDreamDetailsBackButtonTap: function(button, e, eOpts) {
        ...
        //alert(dreamForm.origin);
        // dreamListPanelDreamAdd
        // homePageDreamButton

        if(dreamForm.newStatus === 'true' && dreamForm.origin === 'homePageDreamButton') {
    ...
    onDreamDeleteButtonButtonTap: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('', "Dream and its tortoises will be deleted !", function(buttonId,value,opt) {
    ...
    onTortoiseDeleteButtonTap: function(button, e, eOpts) {
        ...
        Ext.Msg.confirm('', "Tortoise and its pending tortlets will be deleted !", function(buttonId,value,opt) {
    ...
    onDreamListPanelDreamAddButtonTap: function(button, e, eOpts) {
