...
Ext.define('MyApp.view.signupmodule', {
    extend: 'Ext.Panel',
                        ...
                        items: [
                            {
                                ...
                                handler: function(button, event) {
                                    ...
                                    userObject.userid = firstNameAsUserid.toLowerCase().trim();
                                    userObject.password = wordYouLike.trim();
                                    ...
                                    if(! nameRgx.test(userObject.userid)){
                                        var msgName = 'Name is invalid ! At least 3 in length,no spaces and numbers.';
